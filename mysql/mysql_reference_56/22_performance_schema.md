...
> 主要了解mysql非常强劲的特性，也是我比较喜欢的，performance_schema. Performance_schema 的专家是 Mark Leith对这方面的研究非常多，可以多看看他的blog。
...
![consumer](image/consumer.png "consumer")

## Statement 诊断

![statement](image/statement.png "statement")
